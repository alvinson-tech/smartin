-- SMARTIN Database Setup for InfinityFree Hosting
-- IMPORTANT: Make sure you've already created the database in InfinityFree control panel
-- This script should be imported via phpMyAdmin
